export default {
  ...
  toggle_privacy: "Ẩn/hiện số tiền",
  more: "Thêm",
  ...
  year_start_assets: "Tài sản đầu năm {year}",
  ...
  // Analysis
  yearly_analysis: "Phân tích thu chi năm",
  yearly_income: "Tổng thu nhập năm",
  yearly_expense: "Tổng chi tiêu năm",
  system_balance: "Số dư hệ thống",
  monthly: "Tháng {month}",
  monthly_income: "Thu nhập tháng này",
  monthly_expense: "Chi tiêu tháng này",
  monthly_balance: "Số dư tháng này",
  net_cash_flow: "Dòng tiền ròng",
  analysis_overview: "TỔNG QUAN",
  analysis_summary: "Bức tranh tài chính",
  analysis_savings_rate: "Tỷ lệ tiết kiệm",
  analysis_recorded_days: "Ngày có ghi chép",
  analysis_expense_days: "Ngày có chi tiêu",
  analysis_average_expense: "Chi tiêu bình quân/ngày",
  analysis_peak_day: "Ngày chi tiêu cao nhất",
  analysis_trend: "XU HƯỚNG",
  analysis_monthly_trend: "Thu - chi theo tháng",
  analysis_currency_source: "Đơn vị {currency}",
  analysis_breakdown: "CƠ CẤU",
  analysis_category_breakdown: "Chi tiêu theo nhóm",
  analysis_top_five: "5 nhóm lớn nhất",
  analysis_budget: "NGÂN SÁCH",
  analysis_budget_execution: "Mức sử dụng ngân sách",
  analysis_budget_usage: "Đã dùng",
  analysis_budget_months: "Trong hạn mức",
  analysis_budget_total: "Ngân sách năm",
  analysis_monthly_detail: "Chi tiết tháng đang chọn",

  // Asset reconciliation
  asset_reconciliation: "Đối chiếu tài sản",
  ...
  category_dining_short: "Ăn uống",
  category_shopping_short: "Mua sắm",
  category_rent_short: "Nhà ở",
  category_transport_short: "Đi lại",
  category_telecom_short: "Điện thoại",
  category_utilities_short: "Điện nước",
  category_entertainment_short: "Giải trí",
  category_health_short: "Sức khỏe",
  category_social_short: "Đối ngoại",
  category_other_short: "Khác",
  category_other_grouped: "Nhóm khác",
