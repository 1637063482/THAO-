export default {
  ...
  net_cash_flow: "净现金流",
  analysis_overview: "总览",
  analysis_summary: "年度财务概览",
  analysis_savings_rate: "储蓄率",
  analysis_recorded_days: "有记录天数",
  analysis_expense_days: "有支出天数",
  analysis_average_expense: "支出日均",
  analysis_peak_day: "最高支出日",
  analysis_trend: "趋势",
  analysis_monthly_trend: "每月收支趋势",
  analysis_currency_source: "单位：{currency}",
  analysis_breakdown: "构成",
  analysis_category_breakdown: "支出类别构成",
  analysis_top_five: "支出最高的 5 类",
  analysis_budget: "预算",
  analysis_budget_execution: "预算执行情况",
  analysis_budget_usage: "已使用",
  analysis_budget_months: "预算内月份",
  analysis_budget_total: "年度预算",
  analysis_monthly_detail: "当前月份详情",
  ...
  category_other: "其他支出",
  category_dining_short: "餐饮",
  category_shopping_short: "购物",
  category_rent_short: "住房",
  category_transport_short: "出行",
  category_telecom_short: "通讯",
  category_utilities_short: "水电燃气",
  category_entertainment_short: "娱乐",
  category_health_short: "健康",
  category_social_short: "人情社交",
  category_other_short: "其他",
  category_other_grouped: "其他合计",
  income_total: "当日总收入",
