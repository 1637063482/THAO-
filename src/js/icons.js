...
export const Icons = {
  ...
  piggyBank: (cls, sz) => icon('<path d="M19 5c-1.5 0-2.8 1.4-3 2-3.5-1.5-11-1.4-13-1-1.1.2-2 .9-2 2v4c0 1.1.9 2 2 2h2c0 1.5 1.5 3 3.5 3s3.5-1.5 3.5-3h4c0 1.5 1.5 3 3.5 3s3.5-1.5 3.5-3h1a1 1 0 0 0 1-1v-3l-1-2V7c0-.7-.5-1.5-1-2h-2z"/><path d="M9 9h.01"/><path d="M15 9h.01"/>', cls, sz),
