...
var BARRAGE_TEXTS = [
  ...
  // --- Vietnamese barrages ---
  'THAO tuyệt vời! 👏', 'THAO tiểu phú bà! 💰', 'THAO cố lên nhé! 💪', 'THAO giỏi quá! 🌟',
  'Tích tiểu thành đại! 📈', 'Chuyên gia tài chính! 🎯', 'Lại tiết kiệm được một khoản! ✨', 'Tuyệt vời! 💖',
  'Đường đến tự do tài chính! 🚀', 'Tăng thu giảm chi! 🏆', 'Nhà vô địch tiết kiệm! 🐷', 'Hôm nay cũng thật cố gắng! ☀️',
  'Ghi chép làm tôi vui! 😊', 'Mục tiêu nhỏ đã đạt! 🎉', 'Tính toán chi li! 🧮', 'THAO tiểu phú bà đang lên! 👑',
  'THAO em là tuyệt nhất! 🌈', 'Ngày qua ngày thành đại gia! 💎', 'THAO thiên tài ghi chép! 🧠',
  'Tiết kiệm là kiếm tiền! 💵', 'Thói quen tốt mỗi ngày! 📝', 'THAO tự do tài chính không còn xa! 🌟',
  'Cố lên cố lên! 🔥', 'THAO tài lộc dồi dào! 💸', 'Kiên trì là chiến thắng! 🏅',
  'THAO quản lý nhà giỏi! 🏠', 'Tiền nhỏ thành tiền to! 🪙', 'Hôm nay lại để dành được một khoản! 🎊',
  'THAO tương lai rộng mở! 🌅', 'Tài chính làm cuộc sống tươi đẹp hơn! 🌸', 'THAO tự giác là tự do! 🦋',
  'Mỗi khoản là một tích lũy! 📊', 'THAO ngày càng giàu có! 📈', 'Tiết kiệm cho tôi niềm vui! 😄',
  'THAO hướng tới mục tiêu! 🎯', 'Tiết kiệm được là kiếm được! 🤑', 'THAO cố gắng hôm nay giàu có ngày mai! ☀️',
  'Ghi chép mỗi ngày! 📋', 'THAO mật mã tài chính đã mở khóa! 🔑', 'Tiết kiệm chi tiêu quản lý nhà cửa! 🏡',
  'THAO chiến dịch tiết kiệm! ⚔️', 'Cô gái biết ghi chép đẹp nhất! 💃', 'THAO kho bạc ngày càng đầy! 🏦',
  'Tài chính một bước nhỏ giàu có một bước lớn! 👣', 'THAO tiền đẻ ra tiền! 💭', 'Hôm nay tiêu ít hơn mai kiếm nhiều hơn! 🪙',
  'THAO sổ sách ngày càng dày! 📚', 'Góp gió thành bão! ⛰️', 'THAO vững vàng từng bước! 🧱',
  'Ghi chép là bước đầu của tài chính! 🥇', 'THAO tự làm CFO! 💼', 'Tự do tài chính xông lên! 🦆',
  'THAO làm chủ tiền bạc làm chủ cuộc đời! 🎮', 'Kiên trì mỗi ngày là kỳ tích! ✨', 'THAO lại gần hơn với giàu có! 👠',
  'Không tiêu xài hoang phí! 🙅', 'THAO biết chi tiêu biết sống! 🌺', 'Mỗi đồng tiền đều là tình yêu! 💕',
  'THAO sổ sách rõ ràng trong lòng có số! 🧾', 'Tiết kiệm là đầu tư tốt nhất! 📦', 'THAO góp gió thành bão! 🗼',
