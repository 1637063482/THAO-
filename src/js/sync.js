...
export function updateSyncStatus(status) {
  ...
  if (status === "syncing" || status === "delayed") {
    el.className = "sync-status-chip yellow flex items-center gap-1.5 px-3 py-1.5 rounded-full text-sm font-medium transition-colors";
    ...
    el.className = "sync-status-chip green flex items-center gap-1.5 px-3 py-1.5 rounded-full text-sm font-medium transition-colors";
    ...
    el.className = "sync-status-chip red flex items-center gap-1.5 px-3 py-1.5 rounded-full text-sm font-medium transition-colors";
