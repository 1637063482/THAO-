import { createGlobalModalMotion } from "../feedback/global-modal.js";
...
export function bindCommandMenu(root = document) {
  ...
  const motion = createGlobalModalMotion({
    ...
    targetWidth: 560,
    flipX: "--nav-secondary-flip-x",
    flipY: "--nav-secondary-flip-y",
    flipScale: "--nav-secondary-flip-scale",
    flipStartClass: "app-command-menu-dialog--flip-start",
    flipCloseClass: "app-command-menu-dialog--flip-close",
    closeDuration,
    onCloseComplete: () => panelElement.classList.remove("closing"),
  });
